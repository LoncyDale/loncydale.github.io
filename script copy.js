...
var maze = function (X, Y) {
            ...
            for (var i = 0; i < 2 * this.N + 1; i++) {
                for (var j = 0; j < 2 * this.M + 1; j++) {
                    if (this.Board[i][j] != ' '){//} && this.Board[i][j] != '&') {
                        this.ctx.fillStyle = "#0b052d"; // Walls start color. STD = #0b052d
    ...
    this.move =  function (a,b) {
        ...
        //var img = document.getElementById('img_oleg');
        oleg_sprite = new Image(10, 10);
        oleg_sprite.src = 'oleg.png';
        //this.ctx.clearRect(30, 30, 100, 100);
        this.ctx.drawImage(oleg_sprite, (scale * a), (scale * b), 25, 25);
...
function countMoves() {
    document.getElementById("movesCounter").innerHTML = "Moves: "+ m.getMoves()
}
// countMoves();
setInterval(countMoves, 100);
